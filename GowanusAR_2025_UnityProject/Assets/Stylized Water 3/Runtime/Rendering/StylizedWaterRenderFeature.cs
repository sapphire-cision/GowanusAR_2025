...
namespace StylizedWater3
{
    ...
    public partial class StylizedWaterRenderFeature : ScriptableRendererFeature
    {
        ...
        //Note: using the "BeforeRendering" point causes a fatal crash when using DX12
        private readonly RenderPassEvent defaultInjectionPoint = RenderPassEvent.BeforeRenderingShadows;

        ...
        public class RenderPass : ScriptableRenderPass
        {
            ...
            public void Setup(ComputeShader heightReadbackCs)
            {
                if (!heightReadbackCs)
                {
					...
					"This may happen when deleting the Library folder, creating a race condition where the Compute shader isn't yet imported. This will fix itself automatically.");
                }

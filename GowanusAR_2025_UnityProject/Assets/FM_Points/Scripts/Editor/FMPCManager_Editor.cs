    ...
    public override void OnInspectorGUI()
    {
        ...
        //if (Manager.ModeCapture)
        {
...

            {
                ...
                if (Manager.CaptureMode == PCCaptureMode.Object || Manager.CaptureMode == PCCaptureMode.Scene)
                {
                ...
                if (Manager.CaptureMode == PCCaptureMode.Object)
                {
                    if (GUILayout.Button("Capture")) Manager.Action_CaptureObject();
                }
                if (Manager.CaptureMode == PCCaptureMode.Scene)
                {
                    if (GUILayout.Button("Capture")) Manager.Action_CaptureWorld();
                }
            ...
            GUILayout.Space(10);
            {
                GUILayout.BeginVertical("box");
                GUILayout.BeginHorizontal();
                GUILayout.Label(" * RESET for New Capture");
                GUILayout.EndHorizontal();
                GUILayout.EndVertical();

...
public class FMPCHelper_Editor : Editor
{
    ...
    SerializedProperty forceFacingMainCameraProp;
    ...
    void OnEnable()
    {
        ...
        forceFacingMainCameraProp = serializedObject.FindProperty("forceFacingMainCamera");
    ...
    void GUIBrush()
    {
        ...
        {
            GUILayout.BeginHorizontal();
            EditorGUILayout.PropertyField(forceFacingMainCameraProp, new GUIContent(" FacingMainCamera"));
            GUILayout.EndHorizontal();
        }
        GUILayout.EndVertical();
